  ...
  return (
    <div className="bg-background text-on-surface font-body-md selection:bg-primary-fixed selection:text-on-primary-fixed">
        ...
        <div className="learning-lane max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative group">
            ...
            <div className="relative h-[380px] md:h-[500px] w-full rounded-3xl overflow-hidden shadow-2xl">
              <img
                alt="Student focused on chemistry study"
      ...
      <section className="bg-soft-gray py-20 md:py-24">
        <div className="learning-lane max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop">
          <div className="text-center mb-16 space-y-4">
            ...
            <p className="text-on-surface-variant max-w-2xl mx-auto">Premium support designed around the unique challenges of the UK chemistry curriculum.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:-translate-y-2 transition-transform duration-300">
              ...
              <p className="text-on-surface-variant">Sessions that fit into your busy school schedule, available evenings and weekends.</p>
            </div>
            {/* Card 2 */}
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:-translate-y-2 transition-transform duration-300 border-b-4 border-lime-green">
              ...
              <p className="text-on-surface-variant">Premium tutoring at competitive prices, with discount packages for block bookings.</p>
            </div>
            {/* Card 3 */}
            <div className="bg-white p-8 rounded-2xl shadow-sm hover:-translate-y-2 transition-transform duration-300">
              <div className="w-12 h-12 bg-primary-fixed rounded-xl flex items-center justify-center mb-6">
              ...
              <p className="text-on-surface-variant">Learn from specialists who have deep subject knowledge and extensive teaching experience.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="learning-lane max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div className="max-w-2xl">
              <h2 className="font-headline-lg text-headline-lg text-charcoal mb-4 font-bold">Master Every Stage</h2>
              <p className="text-on-surface-variant">From fundamental particles to complex organic synthesis, we provide tailored support for every key stage of your academic journey.</p>
            </div>
          </div>
            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              <div className="bg-soft-gray p-8 rounded-3xl relative overflow-hidden group">
                <div className="relative z-10">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="font-headline-md text-headline-md font-bold">Key Stage 3 (Ages 11-14)</h3>
                  </div>
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    <div className="flex items-center gap-2 bg-white/50 p-3 rounded-lg font-medium"><CheckCircle2 className="text-royal-purple" size={18} /> Particles</div>
                    <div className="flex items-center gap-2 bg-white/50 p-3 rounded-lg font-medium"><CheckCircle2 className="text-royal-purple" size={18} /> Atoms</div>
                    <div className="flex items-center gap-2 bg-white/50 p-3 rounded-lg font-medium"><CheckCircle2 className="text-royal-purple" size={18} /> Chemical Reactions</div>
                    <div className="flex items-center gap-2 bg-white/50 p-3 rounded-lg font-medium"><CheckCircle2 className="text-royal-purple" size={18} /> Acids/Alkalis</div>
                    <div className="flex items-center gap-2 bg-white/50 p-3 rounded-lg font-medium"><CheckCircle2 className="text-royal-purple" size={18} /> Periodic Table</div>
                    <div className="flex items-center gap-2 bg-white/50 p-3 rounded-lg font-medium"><CheckCircle2 className="text-royal-purple" size={18} /> Energy</div>
                  </div>
                </div>
              </div>
              {/* GCSE Chemistry */}
              <div className="bg-white border-2 border-soft-gray p-8 rounded-3xl shadow-sm">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <h3 className="font-headline-md text-headline-md font-bold">GCSE Chemistry (Ages 14-16)</h3>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-4">
                    <h4 className="font-label-md text-label-md text-royal-purple uppercase tracking-widest border-b border-soft-gray pb-2 font-bold">Foundation Tier</h4>
                    <ul className="space-y-3">
                      <li className="flex items-start gap-2 text-on-surface-variant font-medium"><Check className="text-lime-green mt-1" size={18} /> Atomic Structure</li>
                      <li className="flex items-start gap-2 text-on-surface-variant font-medium"><Check className="text-lime-green mt-1" size={18} /> Bonding &amp; Properties</li>
                      <li className="flex items-start gap-2 text-on-surface-variant font-medium"><Check className="text-lime-green mt-1" size={18} /> Energy Changes</li>
                      <li className="flex items-start gap-2 text-on-surface-variant font-medium"><Check className="text-lime-green mt-1" size={18} /> Chemical Analysis</li>
                    </ul>
                  </div>
                  <div className="space-y-4">
                    <h4 className="font-label-md text-label-md text-royal-purple uppercase tracking-widest border-b border-soft-gray pb-2 font-bold">Higher Tier</h4>
                    <ul className="space-y-3">
                      <li className="flex items-start gap-2 text-on-surface-variant font-medium"><Star className="text-royal-purple mt-1" size={18} /> Quantitative Chemistry</li>
                      <li className="flex items-start gap-2 text-on-surface-variant font-medium"><Star className="text-royal-purple mt-1" size={18} /> Organic Chemistry</li>
                      <li className="flex items-start gap-2 text-on-surface-variant font-medium"><Star className="text-royal-purple mt-1" size={18} /> Chemical Changes</li>
                      <li className="flex items-start gap-2 text-on-surface-variant font-medium"><Star className="text-royal-purple mt-1" size={18} /> Earth's Atmosphere</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-primary-container text-on-primary-container p-8 rounded-3xl h-full flex flex-col justify-between">
                <div>
                  <div className="flex items-center gap-3 mb-8">
                    ...
                    <h3 className="font-headline-md text-headline-md text-white font-bold">A-Level Chemistry (16-18)</h3>
                  </div>
                  <div className="space-y-6">
                    <div className="bg-white/10 p-5 rounded-2xl border border-white/20">
                      <h4 className="font-bold mb-2">Physical Chemistry</h4>
                      <p className="text-sm opacity-90">Thermodynamics, kinetics, equilibria, and redox equations.</p>
                    </div>
                    <div className="bg-white/10 p-5 rounded-2xl border border-white/20">
                      <h4 className="font-bold mb-2">Inorganic Chemistry</h4>
                      <p className="text-sm opacity-90">Periodicity, Group 2 and Group 7 elements, and Transition metals.</p>
                    </div>
                    <div className="bg-white/10 p-5 rounded-2xl border border-white/20">
                      <h4 className="font-bold mb-2">Organic Chemistry</h4>
                      <p className="text-sm opacity-90">Functional groups, isomerism, polymers, and amino acids.</p>
                    </div>
                  </div>
                </div>
                <div className="mt-8 rounded-2xl overflow-hidden h-48">
                  <img
                    alt="Collaborative science"
                    className="w-full h-full object-cover"
      ...
      <section className="py-20 md:py-24 bg-soft-gray">
        <div className="learning-lane max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop">
          <h2 className="font-headline-lg text-headline-lg text-charcoal text-center mb-16 font-bold">Why Choose Math Make Smart?</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-gutter">
            <div className="md:col-span-2 bg-white p-10 rounded-3xl shadow-sm flex flex-col justify-between">
              <div>
                <GraduationCap className="text-royal-purple mb-6" size={40} />
                <h3 className="font-headline-md text-headline-md mb-4 text-charcoal font-bold">Experienced Tutors</h3>
                <p className="text-on-surface-variant">Our tutors are PhD holders, researchers, and qualified teachers with a passion for simplifying complex chemistry concepts.</p>
              </div>
            ...
            <div className="bg-white p-10 rounded-3xl shadow-sm">
              ...
              <h3 className="font-headline-md text-headline-md mb-4 text-charcoal font-bold">Exam Prep</h3>
              <p className="text-on-surface-variant">Rigorous practice with past papers and exam-focused techniques.</p>
            </div>
            <div className="bg-white p-10 rounded-3xl shadow-sm">
              <BookOpen className="text-royal-purple mb-6" size={40} />
              <h3 className="font-headline-md text-headline-md mb-4 text-charcoal font-bold">Homework Help</h3>
              <p className="text-on-surface-variant">On-demand support for challenging school assignments and lab reports.</p>
            </div>
            <div className="md:col-span-4 bg-royal-purple p-10 rounded-3xl text-white flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="max-w-xl">
                <h3 className="font-headline-md text-headline-md mb-2 font-bold">Convenient Access</h3>
                <p className="opacity-90">Access your personalized learning dashboard from any device, anywhere in the UK. No travel time, no stress—just high-quality learning.</p>
              </div>
            ...
            <div className="group">
              <div className="relative rounded-2xl overflow-hidden aspect-[4/5] mb-4">
                ...
                <div className="absolute bottom-4 left-4 right-4 z-20">
                  ...
                  <p className="text-white/80 text-xs font-medium">A-Level Organic Chemistry</p>
                </div>
                <div
            ...
            <div className="group">
              <div className="relative rounded-2xl overflow-hidden aspect-[4/5] mb-4">
                ...
                <div className="absolute bottom-4 left-4 right-4 z-20">
                  ...
                  <p className="text-white/80 text-xs font-medium">GCSE Specialist</p>
                </div>
                <div
                  className="w-full h-full bg-cover bg-center group-hover:scale-105 transition-transform duration-500"
            ...
            <div className="group">
              <div className="relative rounded-2xl overflow-hidden aspect-[4/5] mb-4">
                ...
                <div className="absolute bottom-4 left-4 right-4 z-20">
                  ...
                  <p className="text-white/80 text-xs font-medium">IB &amp; A-Level Inorganic</p>
                </div>
                <div
                  className="w-full h-full bg-cover bg-center group-hover:scale-105 transition-transform duration-500"
        ...
        <div className="learning-lane max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop">
          <div className="bg-charcoal rounded-[40px] p-10 md:p-20 text-center relative overflow-hidden group">
            ...
            <div className="relative z-10 space-y-8">
              ...
              <p className="text-white/70 max-w-2xl mx-auto text-body-lg font-sans">Join thousands of students across the UK who are achieving their target grades with Math Make Smart's expert chemistry guidance.</p>
